declare module 'comlink-loader!*' {
  ...
  class WebpackWorker extends Worker {
    ...
    initializeObject(rel: RelationLinkJson, rawData: RawDataJson, rawCategoryData: RawDataJson, rawDescriptions: Descriptions, ageFrom: number | null, ageTo: number): Promise<void>;
