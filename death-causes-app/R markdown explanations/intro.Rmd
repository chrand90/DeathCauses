...
Research by [@dahlberg2004guns] found that a gun in one's home, makes one 1.9 times more likely to be killed in the home, while [@kellermann1993gun] found that a history of domestic physical fights increases that risk by 4.4 times. If one does both, we would want our model to say that the risk is even higher than either, but how much exactly? In this example, and in many others, we have decided that we multiply the risk ratios. That is
