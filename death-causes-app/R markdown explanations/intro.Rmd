...
Many results in health research are presented with binned categories. An example can be taken from @eskelinen2010caffeine, where they found the following risk ratios. They had examined the relation between Alzheimer's and Coffee consumption and in the their analysis they had divided people into three categories; people drinking 0-2 cups of coffe per day, 3-5 cups of coffee per day and 5 or more cups of coffee per day. For each category they computed an [odds ratio](#odds-ratio) of 
