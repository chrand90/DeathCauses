...
$$
\text{RR}=\text{RR}_{\text{smoke amount,age,smoke cessation}}
$$
...
$$
P= P_{\text{smoke amount,age,smoke cessation}}
$$
...
$$
RR=\frac{RR(\text{smoke amount, age})}{RR(\text{smoke amount, age=65})} \cdot \Bigl\[ RR(\text{smoke amount=0, time since smoking=0})+RR() \Bigr\]
$$
